...
function(gen_templates EXTENSION DIMMODE SOURCE_LIST_VAR)
    set(SOURCE_LIST "")
    if(BHC_DIM_ENABLE_2D AND (DIMMODE EQUAL 0 OR DIMMODE EQUAL 2))
        set(DIM_NAME "2D")
        set(BHCGENO3D "false")
        set(BHCGENR3D "false")
    ...
    if(BHC_DIM_ENABLE_3D AND (DIMMODE EQUAL 0 OR DIMMODE EQUAL 3))
        set(DIM_NAME "3D")
        set(BHCGENO3D "true")
        set(BHCGENR3D "true")
        gen_templates_inner(${EXTENSION} SOURCE_LIST_TEMP)
    ...
    if(BHC_DIM_ENABLE_NX2D AND (DIMMODE EQUAL 0 OR DIMMODE EQUAL 4))
        set(DIM_NAME "NX2D")
        set(BHCGENO3D "true")
        set(BHCGENR3D "false")
        gen_templates_inner(${EXTENSION} SOURCE_LIST_TEMP)
