...
#define syncAndCheckKernelErrors(kernelName) __syncAndCheckKernelErrors (kernelName, __FILE__, __LINE__)

inline void __syncAndCheckKernelErrors(const char *kernelName, const char *file, const int line)
{
